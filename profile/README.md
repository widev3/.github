...
The **BIT Model** (Business Integration & Transformation) is the operational backbone of Wide3. It defines:

* How projects are initiated and governed
* How responsibilities are distributed
* How value creation is measured
* How financial flows are managed

The client interacts with a single reference entity while the execution is carried out by multiple contributors behind the scenes.

### Guide Group (GG)

The **Guide Group (GG)** is the central coordination unit for each project. Its responsibilities include:
...
* Lightweight
* Transparent
* Adaptable to different project scales
